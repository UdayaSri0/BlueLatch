...
```bash
sudo apt install ./bluelatch_0.1.1.9_amd64.deb
bluelatch
```
...
```bash
chmod +x BlueLatch-0.1.1.9-x86_64.AppImage
./BlueLatch-0.1.1.9-x86_64.AppImage
```
...
```text
dist/debian/bluelatch_0.1.1.9_amd64.deb
```
...
```text
dist/BlueLatch-0.1.1.9-x86_64.AppImage
```
...
- Download the new `BlueLatch-0.1.1.9-x86_64.AppImage` file.
- Replace the old AppImage file.
- Make sure it stays executable with `chmod +x BlueLatch-0.1.1.9-x86_64.AppImage`.
...
- If you installed from a standalone `.deb`, install the newer `.deb` package with `sudo apt install ./bluelatch_0.1.1.9_amd64.deb`.
